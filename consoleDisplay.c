...
void consoleDisplay(void *data)
{
    ...
    if (*((ConsoleDisplayData *)data)->display)
    {
        ...
        sprintf(getParamValuePtr("solarPanelState"), "");
        sprintf(getParamValuePtr("solarPanelRetract"), "");
        sprintf(getParamValuePtr("solarPanelDeploy"), "");
        sprintf(getParamValuePtr("batteryLev"), "");
        sprintf(getParamValuePtr("fuelLev"), "");
        sprintf(getParamValuePtr("powerCon"), "");
        sprintf(getParamValuePtr("powerGen"), "");
        sprintf(getParamValuePtr("transportDis"), "");
        sprintf(getParamValuePtr("batteryTemp1"), "");
        sprintf(getParamValuePtr("batteryTemp2"), "");
        sprintf(getParamValuePtr("imageData"), "");
        sprintf(getParamValuePtr("batteryLow"), "");
        sprintf(getParamValuePtr("fuelLow"), "");
        sprintf(getParamValuePtr("batteryOverTemp"), "");
    }
}
